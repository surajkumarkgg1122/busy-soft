...
/** Cash flow is ledger-derived. Classification is intentionally conservative; configured account classifications should be used for statutory presentation. */
