...
const entry=(id:string,debit:number,credit:number):LedgerEntry=>({lineId:id,voucherId:"v1",businessId:"biz-qa",financialYearId:"fy-2026-27",accountId:"cash",lineNo:1,debit,credit,date:"2026-08-30",voucherType:"JOURNAL",voucherNumber:"JV-000001",createdAt:"2026-08-30T00:00:00.000Z"});
