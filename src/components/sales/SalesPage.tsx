...
export default function SalesPage() {
  ...
  useEffect(() => {
    const handleSaveShortcut = () => {
      if (showForm && !saving) void save();
    };
    window.addEventListener("busy-soft:save", handleSaveShortcut);
    return () => window.removeEventListener("busy-soft:save", handleSaveShortcut);
  }, [showForm, saving, save]);
