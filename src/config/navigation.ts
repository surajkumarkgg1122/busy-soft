...
export const navigation:NavigationItem[]=[
  ...
  {label:"Parties",href:"/customers",icon:"parties",children:[
  ...
  {label:"Inventory",href:"/inventory",icon:"inventory",children:[
    ...
    {label:"Production Planning",href:"/manufacturing/planning"},
  ...
  {label:"Sales",href:"/sales",icon:"sales",children:[
  ...
  {label:"Reports",href:"/reports/party-wise-statement",icon:"reports",children:[
    {label:"Party Wise Statement",href:"/reports/party-wise-statement"},
    {label:"Party Reports",href:"/reports/parties"},
